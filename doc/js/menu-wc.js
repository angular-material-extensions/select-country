                                ...
                                <a href="modules/MatSelectCountryModule.html" data-type="entity-link">MatSelectCountryModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-MatSelectCountryModule-ae848c28d7291a1c7689ad62d8d437dc"' : 'data-target="#xs-components-links-module-MatSelectCountryModule-ae848c28d7291a1c7689ad62d8d437dc"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-MatSelectCountryModule-ae848c28d7291a1c7689ad62d8d437dc"' :
                                            'id="xs-components-links-module-MatSelectCountryModule-ae848c28d7291a1c7689ad62d8d437dc"' }>
                                            <li class="link">
